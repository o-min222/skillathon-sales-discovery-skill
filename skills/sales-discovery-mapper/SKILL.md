...
See [`references/data-schema.md`](references/data-schema.md) for schema guidance and [`references/dashboard-output-example.json`](references/dashboard-output-example.json) for a complete example.
